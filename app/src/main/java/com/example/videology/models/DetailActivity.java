...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyDgXEnAHDnDNDOOra6YY1I9fUhYvbP7riA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client.get(String.format(VIDEOS_URL, movie.movieId), new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                try {
                    ...
                    Log.e("DetailActivity", "failure to parse Json", e);
                }
            }
